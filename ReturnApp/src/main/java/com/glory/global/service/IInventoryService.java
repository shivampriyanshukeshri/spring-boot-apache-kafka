...
public interface IInventoryService{
    ...
    Set<BookDTO> yetToBeReturnedBookSet(Long studentId, Map<Long, Long> bookIdSlNoMap);
    Boolean isReturnPossible(Long studentId, Long bookId, Long slNo) throws Exception;
